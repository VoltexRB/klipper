...
```
If you get an error message when running the command, you could have several python instances installed.
If thats the case try again with `python3` or simpy `python`  infront of the command.
